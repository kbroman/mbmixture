...
So for these data, the estimate of _p_ is `round(mle["p"], 2)`,
meaning that `round(mle["p"]*100)`% of the microbiome sample came from
the second sample (and `round(100-mle["p"]*100)`% came from the first
sample). The estimate of the sequencing error rate is `round(mle["e"],
3)`.
